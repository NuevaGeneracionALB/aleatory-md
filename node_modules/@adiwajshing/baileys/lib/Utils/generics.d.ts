...
export declare const bindWaitForConnectionUpdate: (ev: BaileysEventEmitter) => (check: (u: Partial<import("@adiwajshing/baileys/src/Types/State").ConnectionState>) => boolean | undefined, timeoutMs?: number) => Promise<void>;
